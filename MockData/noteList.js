...
mockObj[0] = {
	...
	title: '자바 프로그래밍',
	tags: ['3학년1학기', '코딩', '바보', '병신', '그냥', '리액트', '평규'],
	isPublish: false,
	preview: `현재 중학교 3학년 학생들에게 적용되는 2021학년도 대학 수학능력시험 개편안이 이르면 다음달 확정된다. 문재인 대통령의 공약인 수능 전과목 절대평가 전환과 맞물려 일부 과목에 적용되는 단계적 절대평가화가 예상되는 가운데 학생과 학부모들 사이에선 반대 목소리가 만만치 않다.
...
`,
	...
	data: '<p>리안노트는 다양한 기능을 보다 쉽고 빠르게 사용할 수 있는 <strong>소셜 노트 네트워크 어플리케이션</strong> 입니다. 몇가지 기능과 함께 리안노트를 간단히 소개드리겠습니다.</p><p><br></p><p><br></p><h1>카드 리스트와 노트 리스트</h1><p>리안노트의 노트를 볼 수 있는 방법은 크게 두 가지로 나뉩니다. <u>카드형태로 노트를 볼 수 있는 <strong>\'</strong><strong>카드 리스트</strong><strong>\'</strong> 모드</u>와, <u>사이드바의 노트 목록을 통해 노트를 볼 수 있는 <strong>\'</strong><strong>노트 리스트</strong><strong>\'</strong> 모드</u> 입니다. 각각의 모드에서는 노트를 보기 쉽도록 정렬해서 볼 수 있는 몇 가지의 방법들이 있습니다.</p><p><br></p><ol><li><strong>작성한 시간 순</strong></li><li><strong>작성한 시간 역순</strong></li><li><strong>수정한 시간 순</strong></li><li><strong>수정한 시간 역순</strong></li></ol><p><br></p><p>위의 정렬 방법들을 사용해서 노트를 정렬하기 위해서는, 간단히 각 사이드바 우측에 있는 <strong><u>드롭다운 버튼</u></strong><u>을 눌러서 사용하고자 하는 정렬 방식을 선택</u>하기만 하면 됩니다.</p><p><br></p><p><br></p><p><br></p><h1>태그</h1><p>리안노트에서 작성한 노트들은 <strong>\'</strong><strong><u>태그\'</u></strong><u>를 통해 정리할 수 있습니다</u>. 노트에 태그를 삽입하려면, 노트 작성/편집 모드에서 노트 가장 상단에 있는 <strong>\'</strong><strong>Tag\'</strong> 필드에 <strong>#</strong>을 친 상태에서 태그를 입력하면 됩니다.</p><p><br></p><p>예시)</p><ul><li><strong>#리안#노트#사용법#태그#예시</strong></li></ul><p><br></p><p><br></p><p><br></p><h1>집중모드</h1><p>리안노트의 글쓰기 경험을 최대화 시킬 수 있는 <strong>집중모드</strong>는 사용자들이 온전히 \'글쓰기\' 라는 행위에만 집중할 수 있게 도와줍니다. <strong>노트 리스트</strong> 모드에서 상단의 헤더 오른쪽에 위치한 <strong>\'집중\'</strong> 버튼을 누르면 <u>강력한 글쓰기 경험을 제공하는 <strong>집중모드</strong></u>에서 노트 작성 및 편집을 할 수 있습니다.</p><p><br></p><p>지금 바로 <strong>노트 리스트</strong> 모드로 전환하고, 우측 상단의 <strong>\'집중\'</strong> 버튼을 눌러서 <u>리안노트가 제공하는 최상의 글쓰기 경험</u>을 경험해보세요!</p><p><br></p><p><br></p><p><br></p><p><br></p><p><br></p><p><br></p><p><br></p><p><br></p><p><br></p>',
};
mockObj[1] = {
	_id: Math.floor(Math.random() * 10000),
